...
import { Camera, Lock, Mail, ArrowRight, AlertCircle, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-3xl border border-slate-200 shadow-xs">
        <div className="text-center">
          <div className="mx-auto w-12 h-12 rounded-2xl bg-indigo-600 text-white flex items-center justify-center shadow-md shadow-indigo-100 mb-4">
          ...
          <p className="mt-2 text-xs text-slate-500">
            Painel do fotógrafo no {APP_CONFIG.appName}
          </p>
        </div>
